...
class ScoresProject:
    def __init__(self,root):
       ...
       export_csv_btn = tk.Button(root,text='csv تولید فایل',command=self.export_csv,width=20,bg='LIGHTGREEN')
    ...
    def open_701_window(self):
        ...
        def add_student():
            ...
            if not surname or (not surname.isalpha()):
                return          
            nc = simpledialog.askinteger('Input','کد ملی دانش اموز را وارد کنید',parent=window)
            if len(str(nc))!=10:
                return
            ...
            if not isnum:
                crs.execute('INSERT INTO class701 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
    ...
    def open_702_window(self):
        ...
        def add_student():
            ...
            if isnum:
                messagebox.showerror('خطا','همه ی نمرات باید بین 0 و 20 باشند')
            if not isnum:
                crs.execute('INSERT INTO class702 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
            crs.execute("UPDATE class702 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def open_703_window(self):
        ...
        def add_student():
            ...
            if isnum:
                messagebox.showerror('خطا','همه ی نمرات باید بین 0 و 20 باشند')
            if not isnum:
                crs.execute('INSERT INTO class703 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
            crs.execute("UPDATE class703 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def open_704_window(self):
        ...
        def add_student():
            ...
            if isnum:
                messagebox.showerror('خطا','همه ی نمرات باید بین 0 و 20 باشند')
            if not isnum:
                crs.execute('INSERT INTO class704 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
            crs.execute("UPDATE class704 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def open_801_window(self):
        ...
        def add_student():
            ...
            if isnum:
                messagebox.showerror('خطا','همه ی نمرات باید بین 0 و 20 باشند')
            if not isnum:
                crs.execute('INSERT INTO class801 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
            crs.execute("UPDATE class801 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def open_802_window(self):
        ...
        def add_student():
            ...
            if isnum:
                messagebox.showerror('خطا','همه ی نمرات باید بین 0 و 20 باشند')
            if not isnum:
                crs.execute('INSERT INTO class802 (name,surname,nationalcode,art,sport,english,technology,socialstudies,writing,dictation,literature,math,science,arabic,thinkinglifestyle,religious,quran,plusone) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(name,surname,nc,art_score,sport_score,english_score,technology_score,socialstudies_score,writing_score,dictation_score,leterature_score,math_score,science_score,arabic_score,thinklifestyle_score,religious_score,quran_score,plusone_score))
                conn.commit()
                load_data()
        ...
        def update_student():
            ...
            if (len(str(nc))!=10) or not nc.isalnum():
                return
            crs.execute("UPDATE class802 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def open_901_window(self):
        ...
        window.geometry("1200x400")  
        tree = ttk.Treeview(window, columns=( "ID","Name",'Surname',"nc" ,"Art", "Sport", "English", 'Technology', 'Socialstudies', 'Writing', 'Dictation', 'Literature', 'Math', 'Science', 'Arabic', 'Thinkinglifestyle', 'Religious', 'Quran','difensive',  'plusone' ), show='headings')
        tree.heading("ID", text="ایدی")
        tree.heading("Name", text='نام')
        tree.heading('Surname',text='نام خانوادگی')
        tree.heading('nc',text='کد ملی')
        ...
        def update_student():
            ...
            if len(str(nc))!=10:
                return
            crs.execute("UPDATE class901 SET name=?, surname=?,nationalcode=? WHERE id=?", (name, surname,nc, cid))
            conn.commit()
            load_data()
    ...
    def export_csv(self):
            ...
            try:
                with open(filepath, 'w', newline='', encoding='utf-8') as csvfile:
                    ...
                    crs.execute("SELECT * FROM class701")
                    writer.writerow(["ID","Name",'Surname',"nationalcode" ,"Art", "Sport", "English", 'Technology', 'Socialstudies', 'Writing', 'Dictation', 'Literature', 'Math', 'Science', 'Arabic', 'Thinkinglifestyle', 'Religious', 'Quran',  'plusone'])
                    for row in crs.fetchall():
                        writer.writerow(row) 
                    writer.writerow([])
                    crs.execute('SELECT * FROM class702')
                    ...
                    writer.writerow([])
                    crs.execute('SELECT * FROM class901')
                    writer.writerow(["ID","Name",'Surname',"nationalcode" ,"Art", "Sport", "English", 'Technology', 'Socialstudies', 'Writing', 'Dictation', 'Literature', 'Math', 'Science', 'Arabic', 'Thinkinglifestyle', 'Religious', 'Quran','difensive',  'plusone'])
                    for row in crs.fetchall():
                        writer.writerow(row)
                    writer.writerow([])
